    ...
    >
      <div className="mx-auto grid max-w-7xl items-center gap-8 px-4 py-12 sm:px-6 sm:py-14 lg:grid-cols-[1.03fr_0.97fr] lg:px-8 lg:py-16">
        <div className="relative z-10">
          ...
          <h1 className="mt-5 max-w-4xl text-4xl font-black leading-tight text-edch-ink sm:text-5xl dark:text-white">
            {siteContent.hero.headline}
          </h1>
          <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-600 sm:text-xl dark:text-slate-200">
