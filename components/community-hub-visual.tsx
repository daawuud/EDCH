...
export function CommunityHubVisual() {
  return (
    <div className="relative z-10">
      <div className="rounded-[2rem] border border-white bg-white/90 p-3 shadow-soft backdrop-blur dark:border-white/10 dark:bg-white/10">
        <div className="rounded-[1.5rem] bg-[#123a66] p-4 text-white dark:bg-slate-900">
          <div className="mb-3 rounded-3xl bg-white/10 p-3 ring-1 ring-white/10">
          ...
          <div className="grid gap-2 md:grid-cols-3">
            {stats.map((item) => (
              <Link
                ...
                className="group flex flex-col rounded-2xl bg-white p-3 text-edch-ink shadow-sm ring-1 ring-white/20 transition hover:-translate-y-1 hover:shadow-xl focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-emerald-300 dark:bg-white/10 dark:text-white"
              >
                ...
                <p className="mt-2 text-2xl font-black text-edch-green dark:text-emerald-300">
                  {item.value}
                </p>
          ...
          <div className="mt-2 rounded-3xl bg-white p-3 text-edch-ink shadow-sm dark:bg-white/10 dark:text-white">
